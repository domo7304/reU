...
public class UserDao {
    ...
    public int modifyUserStatus(PatchUserStatusReq patchUserStatusReq) {
        ...
        Object[] modifyUserStatusParams = new Object[]{patchUserStatusReq.getState(), patchUserStatusReq.getUserId()}; // 주입될 값들(nickname, userIdx) 순
    ...
    public int saveUserPoint(PatchUserPointReq patchUserPointReq) {
        String modifyUserPointQuery = "update User set point = ? where userId = ? ";
        // 주입될 값들(point, userId) 순
        Object[] modifyUserPointParams = new Object[]{patchUserPointReq.getPoint(), patchUserPointReq.getUserId()};
