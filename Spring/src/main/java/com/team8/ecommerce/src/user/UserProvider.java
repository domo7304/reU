...
import com.team8.ecommerce.src.user.model.GetUserRes;
import com.team8.ecommerce.src.user.model.PostLoginReq;
import com.team8.ecommerce.src.user.model.PostLoginRes;
...
public class UserProvider {
    ...
    public PostLoginRes logIn(PostLoginReq postLoginReq) throws BaseException {
        ...
        //비밀번호가 일치한다면 userId를 return
        if (postLoginReq.getPassword().equals(password)) {
            return new PostLoginRes(user.getUserId());
