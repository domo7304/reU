package com.team8.ecommerce.config;
...
public enum BaseResponseStatus {
    ...
    POST_USERS_EMPTY_PHONE(false, 2023, "휴대폰 번호를 입력해주세요."),
    POST_USERS_INVALID_PHONE(false,2024, "휴대폰 번호 형식을 확인해주세요."),
    // -----------------------
    ...
    //[PATCH] /users/{userId}
    MODIFY_FAIL_USER_POINT(false,4014,"회원 포인트 적립에 실패하였습니다."),
    MODIFY_FAIL_USER_STATE(false,4015,"회원 상태 변경에 실패하였습니다."),
